...
library(gtrendsR) #Downloading Google Data
...
##### How has the return to Bitcoin been against other assets? Is it possible that bitcoin can be a safe haven or maybe a hedge against bad times?
...
p<-df %>% 
  ...
  xlab("Date") +
  labs(title = "logarithmic return on cumulative form from 2016-2020",
       subtitle = "",
...
Here is a graph showing the best investment, given these 5 assets over time: Just pull the slidebar
